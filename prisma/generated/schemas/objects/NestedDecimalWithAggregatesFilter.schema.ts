...
const Schema: z.ZodType<Prisma.NestedDecimalWithAggregatesFilter> = z
    .object({
        ...
        not: z
            .union([z.number(), z.lazy(() => NestedDecimalWithAggregatesFilterObjectSchema)])
            .optional(),
...
export const NestedDecimalWithAggregatesFilterObjectSchema = Schema;
